...
const HERO_PROJECT_SLIDES: SlideProject[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/artists/tre-sax-cover.jpg',
  ...
  },
  {
    ...
    imageUrl: '/images/artists/carolina-de-athey-cover.jpg',
  ...
  },
  {
    ...
    subtitle: 'SO BOLD ENT CEO — BILLBOARD & GRAMMY SPOTLIGHTED EXECUTIVE',
    category: 'TALENT ARCHITECT & PRODUCER',
    imageUrl: '/images/artists/douglas-lofton-jr-avatar.jpg',
    linkHref: '/clients/douglas-lofton-jr',
    buttonLabel: 'Explore CEO Profile & Press Features',
    quote: 'Building a legacy platform where real artists get real opportunities.',
  },
  {
    id: 'c12-mic',
